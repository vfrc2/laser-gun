...
${OBJECTDIR}/src/main.o: src/main.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.c

${OBJECTDIR}/src/playerState/player.o: src/playerState/player.c 
	${MKDIR} -p ${OBJECTDIR}/src/playerState
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/playerState/player.o src/playerState/player.c
